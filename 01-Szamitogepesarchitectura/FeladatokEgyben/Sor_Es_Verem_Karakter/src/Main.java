...
class CharSor {
    ...
    public char Sorelhagy() {
        char elsoErtek = adatokASorban.AdottPozicioLekerdezese(0);
...
class CharVerem {
    ...
    public char Kivesz() {
        char elsoErtek = adatokAVeremben.AdottPozicioLekerdezese(0);
...
class LancoltLista {
    ...
    public char AdottPozicioLekerdezese(int poz) {
        Lancszem adottPozicionLevoSzem = this.elso;
        for (int i = 0; i < poz; i++) {
            adottPozicionLevoSzem = adottPozicionLevoSzem.GetKovetkezo();
        }
