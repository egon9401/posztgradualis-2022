...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int kettevalasztas = playerNames.length / 2;
        String[] teamA = Arrays.copyOfRange(playerNames, 0, kettevalasztas);
        String[] teamB = Arrays.copyOfRange(playerNames, kettevalasztas, playerNames.length);
